...
public class BirdHardScript : MonoBehaviour
{
    ...
    public TubosHardScript tubo1;
    public TubosHardScript tubo2;
    ...
    {
        PlayerPrefs.SetString("PuntajeHard", puntaje);
    }
    public void Cargar()
    {
       
            PMaximo.text = PlayerPrefs.GetString("PuntajeHard", "0");
